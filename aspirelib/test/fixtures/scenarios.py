...
```
mv aspirelib/test/fixtures/scenarios/unittest_fixture.new.json aspirelib/test/fixtures/scenarios/unittest_fixture.json
mv aspirelib/test/fixtures/scenarios/unittest_fixture.new.sql aspirelib/test/fixtures/scenarios/unittest_fixture.sql
mv aspirelib/test/fixtures/scenarios/unittest_fixture.new.log aspirelib/test/fixtures/scenarios/unittest_fixture.log
```
...
UNITTEST_FIXTURE = [
    ...
    ['order', (ADDR[0], 'ASP', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'DIVISIBLE', DP['quantity']), {'encoding': 'multisig'}, None],
    ['send', (ADDR[0], ADDR[1], 'ASP', DP['quantity']), {'encoding': 'multisig'}, None],
    ['order', (ADDR[0], 'ASP', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'ASP', DP['quantity'], 'GASP', round(DP['quantity'] / 100), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'GASP', round(DP['quantity'] / 150), 'ASP', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ['send', (ADDR[0], MULTISIGADDR[0], 'ASP', DP['quantity'] * 3), {'encoding': 'multisig'}, None],
    ...
    ['send', (ADDR[0], ADDR[1], 'ASP', DP['quantity'], 'hello', False, True), {'encoding': 'opreturn'}, {'enhanced_sends': True}],
    ['send', (ADDR[1], ADDR[0], 'ASP', DP['quantity'], 'fade0001', True, True), {'encoding': 'opreturn'}, {'enhanced_sends': True}],
    ...
    ['order', (ADDR[0], 'ASP', DP['quantity'], 'GASP', round(DP['quantity'] / 125), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[1], 'GASP', round(DP['quantity'] / 125), 'ASP', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ...
    ['send', (ADDR[2], ADDR[3], 'ASP', 92945878046), {'encoding': 'multisig'}, None],
...
def generate_standard_scenario(address1, address2, order_matches):
    ...
    return [
        ...
        ['send', (address1, address2, 'ASP', DP['small']), {'encoding': 'multisig'}, None],
        ['order', (address1, 'GASP', DP['small'], 'ASP', DP['small'] * 2, DP['expiration'], 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
        ['order', (address1, 'ASP', round(DP['small'] * 2.1), 'GASP', DP['small'], DP['expiration'], DP['fee_required']), {'encoding': 'multisig'}],
        ...
        ['dividend', (address1, 600, 'BBBB', 'ASP'), {'encoding': 'multisig'}],
        ['dividend', (address1, 800, 'BBBC', 'ASP'), {'encoding': 'multisig'}],
        ...
        ['order', (address1, 'BBBB', DP['small'], 'ASP', DP['small'], DP['expiration'], 0), {'encoding': 'multisig'}],
        ['burn', (address1, (1 * DP['quantity']), True), {'encoding': 'multisig'}],  # Try to burn a whole 'nother GASP.
