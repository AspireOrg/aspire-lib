...
from aspirelib.lib import config, util, database, api
...
def generate_random_asset ():
    if RANDOM_ASSET_INT is None:
        ...
        return 'ASP' + str(RANDOM_ASSET_INT)
...
def init_mock_functions(monkeypatch, rawtransactions_db):
    ...
    monkeypatch.setattr('aspirelib.lib.backend.getrawtransaction', get_cached_raw_transaction)
