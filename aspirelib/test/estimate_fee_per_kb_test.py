...
from aspirelib.test.fixtures.params import DEFAULT_PARAMS as DP, ADDR
from aspirelib.test.util_test import CURR_DIR
from aspirelib.test import util_test

from aspirelib.lib import (blocks, transaction, api, backend)
...
def test_estimate_fee_per_kb(fee_per_kb, fee_per_kb_used, server_db, monkeypatch):
    ...
    monkeypatch.setattr('aspirelib.lib.backend.fee_per_kb', _fee_per_kb)
