...
DEFAULT_INDEXD_PORT_TESTNET = 18334
DEFAULT_INDEXD_PORT = 8334
...
ESTIMATE_FEE_PER_KB = False              # when True will use `estimatesmartfee` from bitcoind instead of DEFAULT_FEE_PER_KB
