...
from aspirelib.lib import transaction
...
from aspirelib.lib.messages import sweep
from aspirelib.lib.messages import dispenser

API_TABLES = ['assets', 'balances', 'credits', 'debits', 'bets', 'bet_matches',
              'broadcasts', 'proofofwork', 'btcpays', 'cancels', 'destructions',
...
API_TRANSACTIONS = ['bet', 'broadcast', 'proofofwork', 'btcpay', 'cancel', 'destroy',
...
def compose_transaction(db, name, params,
    ...
    compose_method = sys.modules['aspirelib.lib.messages.{}'.format(name)].compose
    ...
    def run(self):
        ...
        def get_element_counts():
            ...
            for element in ['transactions', 'blocks', 'debits', 'credits', 'balances', 'sends', 'orders',
                ...
                'cancels', 'order_expirations', 'bet_expirations', 'order_match_expirations',
                'bet_match_expirations', 'proofofwork', 'messages', 'destructions']:
