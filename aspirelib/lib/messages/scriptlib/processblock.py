...
from aspirelib.lib.messages.scriptlib import (rlp, utils, opcodes, blocks)
...
def apply_op(db, block, tx, msg, processed_code, compustate):
    ...
    if op == 'STOP' or op == 'INVALID':
        ...
        # TODO: You can’t send GASP to a contract address.
...
#        stk.append(block.gas_limit)
        ...
        # TODO: Check that this allows for the sending of ASP to Aspire addresses, as well as contract addresses.
